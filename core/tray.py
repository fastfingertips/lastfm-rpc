            ...
            MenuItem(
                ...
                Menu(
                    MenuItem(
                        ...
                        checked=lambda item: self.app.rpc.show_artist_scrobbles_large,
                    ),
                    MenuItem(
                        messenger("menu_show_album_name"),
                        lambda item: self.app.set_large_image_option(False),
                        checked=lambda item: not self.app.rpc.show_artist_scrobbles_large,
                    ),
                ),
            ),
            Menu.SEPARATOR,
